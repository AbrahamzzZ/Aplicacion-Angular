...
AS
BEGIN
	SELECT ID_USUARIO, CODIGO, NOMBRE_COMPLETO, CLAVE, CORREO_ELECTRONICO, ESTADO, CONVERT(CHAR(10), FECHA_CREACION, 103)[FechaRegistro] FROM USUARIO;
END;
GO
...
AS
BEGIN
	SELECT ID_PROVEEDOR, CODIGO, NOMBRES, APELLIDOS, CEDULA, TELEFONO, CORREO_ELECTRONICO, ESTADO, CONVERT(CHAR(10), FECHA_REGISTRO, 103)[FechaRegistro] FROM PROVEEDOR;
END;
GO
...
AS
BEGIN
	SELECT ID_TRANSPORTISTA, CODIGO, NOMBRES, APELLIDOS, CEDULA, TELEFONO, CORREO_ELECTRONICO, IMAGEN, ESTADO, CONVERT(CHAR(10), FECHA_REGISTRO, 103)[FechaRegistro] FROM TRANSPORTISTA;
END;
GO
...
CREATE PROCEDURE PA_ELIMINAR_TRANSPORTITA(
@Id_Transportista int
)
AS
BEGIN
...
AS
BEGIN
	SELECT ID_CLIENTE, CODIGO, NOMBRES, APELLIDOS, CEDULA, TELEFONO, CORREO_ELECTRONICO, CONVERT(CHAR(10), FECHA_REGISTRO, 103)[FechaRegistro] FROM CLIENTE;
END;
GO
